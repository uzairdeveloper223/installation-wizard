...
static void test_has_root_partition_no_root(void **state)
{
    ...
    strncpy(store->partitions[0].mount_point, "/home", MAX_MOUNT_LEN);
    strncpy(store->partitions[1].mount_point, "/boot", MAX_MOUNT_LEN);
...
static void test_has_root_partition_multiple(void **state)
{
    ...
    strncpy(store->partitions[2].mount_point, "/home", MAX_MOUNT_LEN);
...
static void test_validate_uefi_boot_has_bios_grub(void **state)
{
    ...
    strncpy(store->partitions[1].mount_point, "/boot/efi", MAX_MOUNT_LEN);
...
static void test_validate_bios_gpt_boot_has_esp(void **state)
{
    ...
    strncpy(store->partitions[1].mount_point, "[none]", MAX_MOUNT_LEN);
...
static void test_validate_boot_config_with_boot(void **state)
{
    ...
    strncpy(store->partitions[2].mount_point, "/", MAX_MOUNT_LEN);
